...
import { h as useParams, g as useNavigate } from "./index-XkXksHqM.js";
const AddFertilizerStatusForm = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CForm, { ref: formRef, className: "needs-validation", noValidate: true, validated, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CRow, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CCol, { md: 6, className: "mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      CFormSelect,
      {
        "aria-label": "Válassz virágcsoportot",
        className: "mb-3",
        feedbackInvalid: "Válassz virágcsoportot",
        required: true,
        onChange: handleLotChange,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Válassz virágcsoportot" }),
          lots.map((val) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: val.id, children: [
            val.name,
            " "
          ] }, val.id))
        ]
