...
import { h as useParams, g as useNavigate } from "./index-C98SRLOe.js";
const AddFertilizerStatusForm = () => {
  ...
  const lotRef = reactExports.useRef();
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CCol, { md: 6, className: "mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CFormFloating, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        CFormInput,
        {
          ...
          id: "lot",
          placeholder: "Lot",
          feedbackInvalid: "Válassz egy virágcsoportot",
          required: true,
          disabled: action == "Hozzáadás" ? true : false
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CFormLabel, { htmlFor: "lot", children: "Virágcsoport" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CCol, { md: 6, className: "mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CFormFloating, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        CFormInput,
