...
import { r as reactExports, d as reactDomExports, R as React, j as jsxRuntimeExports } from "./client-DnTwIhck.js";
import { d as CCard, a0 as CCardHeader, e as CCardBody } from "./index.es-DQOCfkkb.js";
import { a4 as ProBadge } from "./ProBadge-C_ssrJzR.js";
...
(typeof globalThis !== "undefined" ? globalThis : window).FullCalendarVDom = {
  ...
  render: reactDomExports.render,
  createRef: reactExports.createRef,
  Fragment: reactExports.Fragment,
  createContext: reactExports.createContext,
  createPortal: reactDomExports.createPortal,
  flushSync,
  unmountComponentAtNode: reactDomExports.unmountComponentAtNode
...
FullCalendarVDom.render;
var createRef = FullCalendarVDom.createRef;
var Fragment = FullCalendarVDom.Fragment;
var createContext = FullCalendarVDom.createContext;
var createPortal = FullCalendarVDom.createPortal;
FullCalendarVDom.flushSync;
FullCalendarVDom.unmountComponentAtNode;
/*!
...
var FullCalendar = (
  ...
  function(_super) {
    ...
    FullCalendar2.prototype.render = function() {
      return reactExports.createElement(CalendarDataProvider, { optionOverrides: this.props, calendarApi: this._calendarApi }, function(data) {
        return reactExports.createElement(CalendarRoot, { options: data.calendarOptions, theme: data.theme, emitter: data.emitter }, function(classNames, height, isHeightAuto, forPrint) {
          return reactExports.createElement(
            "div",
            { className: classNames.join(" "), style: { height } },
            reactExports.createElement(CalendarContent, __assign({ isHeightAuto, forPrint }, data))
          );
        });
      });
    };
...
const FullCalendar$1 = FullCalendar;
/*!
FullCalendar v5.11.5
Docs & License: https://fullcalendar.io/
(c) 2022 Adam Shaw
...
const interactionPlugin = main;
let eventGuid = 0;
let todayStr = (/* @__PURE__ */ new Date()).toISOString().replace(/T.*$/, "");
...
class Calendar extends React.Component {
  constructor() {
    ...
    __publicField(this, "handleWeekendsToggle", () => {
      this.setState({
        weekendsVisible: !this.state.weekendsVisible
      });
    });
    __publicField(this, "handleDateSelect", (selectInfo) => {
    ...
    __publicField(this, "handleEventClick", (clickInfo) => {
      if (confirm(`Are you sure you want to delete the event '${clickInfo.event.title}'`)) {
        clickInfo.event.remove();
      }
    });
    __publicField(this, "handleEvents", (events) => {
      this.setState({
...
const renderEventContent = (eventInfo) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: eventInfo.timeText }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("i", { children: eventInfo.event.title })
  ] });
};
export {
  Calendar as default
