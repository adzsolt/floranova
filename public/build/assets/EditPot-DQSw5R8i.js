...
import { f as CForm, a as CRow, b as CCol, a6 as CFormFloating, j as CFormInput, a7 as CFormLabel, ae as CAlert, a2 as CLoadingButton, k as CButton, d as CCard, e as CCardBody, u as CCardTitle } from "./index.es-CuBG9yLS.js";
import { a as axios } from "./axios-fEUzBR8L.js";
import { u as useNavigate, a as useParams } from "./index-DOY0rKmI.js";
const EditPotForm = ({ pot }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CForm, { ref: formRef, className: "needs-validation", noValidate: true, validated, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CRow, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CCol, { md: 6, className: "mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CFormFloating, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CFormInput, { ref: sizeRef, type: "number", name: "size", id: "size", placeholder: "Cserép neve", disabled: isLoading, defaultValue: pot.price, feedbackInvalid: "A cserép mérete kötelező", required: true }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CFormLabel, { htmlFor: "name", children: "Cserép mérete" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CCol, { md: 6, className: "mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CFormFloating, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CFormInput, { ref: priceRef, type: "number", name: "price", id: "price", placeholder: "Cseráp ára", disabled: isLoading, defaultValue: pot.price, feedbackInvalid: "A cserép ára kötelező", required: true }),
