...
import { g as useNavigate, h as useParams } from "./index-FVFFpgU8.js";
const EditProductionUnitForm = ({ production_unit }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CForm, { ref: formRef, className: "needs-validation", noValidate: true, validated, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CRow, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CCol, { xs: 6, className: "mb-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CFormSelect, { "aria-label": "Válassz fűtőegységet", id: "heat-unit", className: "mb-3", defaultValue: production_unit.heat_unit, onChange: handleHeatUnitChange, children: heatUnits.map((val) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: val.id, children: [
        val.name,
        " "
      ] }, val.id)) })
    ] }),
