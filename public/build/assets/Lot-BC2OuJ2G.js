...
import { a as CRow, b as CCol, d as CCard, a2 as CCardHeader, e as CCardBody, aF as CModal, aG as CModalHeader, aH as CModalTitle, aI as CModalBody, f as CForm, a1 as CDatePicker, ax as CFormSelect, k as CButton, aJ as CModalFooter, z as CSpinner, Z as CCallout, aC as CAlert, j as CFormInput, l as CFormLabel, aP as CSmartTable, af as CCollapse, at as CLoadingButton, a0 as CCardTitle, i as CIcon } from "./index.es-HjcCfGYB.js";
import { g as useNavigate } from "./index-CIFLnhwK.js";
import { a as axios } from "./axios-fEUzBR8L.js";
import "./ProBadge-CB1qRVQp.js";
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CModalBody, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CCallout, { color: "primary", className: priceInfo, children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(CAlert, { color: "info", children: [
                    ...
                    " / ",
                    formatNumber(priceResponse.plant * priceResponse.lot_quantity)
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(CAlert, { color: "info", children: [
                    "Cserép ára: ",
                    formatNumber(priceResponse.pot_price),
                    " / ",
                    formatNumber(priceResponse.pot_price * priceResponse.lot_quantity)
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(CAlert, { color: "info", children: [
                    "Tőzeg ára: ",
                    formatNumber(priceResponse.peat_price),
                    " / ",
                    formatNumber(priceResponse.peat_price * priceResponse.lot_quantity)
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(CAlert, { color: "info", children: [
                    "Műtrágya: ",
                    formatNumber(priceResponse.fertilizer_price),
                    " / ",
                    formatNumber(priceResponse.fertilizer_price * priceResponse.lot_quantity)
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(CAlert, { color: "info", children: [
                    "Munkaköltség ára: ",
                    formatNumber(priceResponse.work_price),
                    " / ",
                    formatNumber(priceResponse.work_price * priceResponse.lot_quantity)
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(CAlert, { color: "info", children: [
                    "Energia ára: ",
                    formatNumber(priceResponse.spend_price),
                    " / ",
                    formatNumber(priceResponse.spend_price * priceResponse.lot_quantity)
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(CAlert, { color: "warning", children: [
                    "Összesen: ",
                    formatNumber(priceResponse.total_price),
                    " / ",
                    formatNumber(priceResponse.total_price * priceResponse.lot_quantity)
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(CAlert, { color: "primary", children: [
                    "Minimális eladási ár: ",
                    formatNumber(priceResponse.total_price * 1.35)
                  ] })
                ] })
              ] }),
