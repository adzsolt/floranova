import { r as reactExports, R as React } from "./client-DnTwIhck.js";
...
var eq$3 = eq_1, isArrayLike$5 = isArrayLike_1, isIndex$2 = _isIndex, isObject$6 = isObject_1;
...
var baseTimes = _baseTimes, isArguments$2 = isArguments_1, isArray$8 = isArray_1, isBuffer$2 = isBufferExports, isIndex$1 = _isIndex, isTypedArray$2 = isTypedArray_1;
...
var keys_1 = keys$4;
var assignValue = _assignValue, copyObject$1 = _copyObject, createAssigner$1 = _createAssigner, isArrayLike$3 = isArrayLike_1, isPrototype$2 = _isPrototype, keys$3 = keys_1;
...
var Stack$2 = _Stack, equalArrays = _equalArrays, equalByTag = _equalByTag, equalObjects = _equalObjects, getTag = _getTag, isArray$6 = isArray_1, isBuffer$1 = isBufferExports, isTypedArray$1 = isTypedArray_1;
...
var castPath = _castPath, isArguments$1 = isArguments_1, isArray$2 = isArray_1, isIndex = _isIndex, isLength = isLength_1, toKey$2 = _toKey;
...
var baseIteratee$1 = _baseIteratee, isArrayLike$2 = isArrayLike_1, keys = keys_1;
...
var CChart = reactExports.forwardRef(function(_a, ref) {
  ...
  var chartRef = reactExports.useRef();
  var computedData = reactExports.useMemo(function() {
    if (typeof data === "function") {
      return canvasRef.current ? data(canvasRef.current) : { datasets: [] };
    }
    return merge$1({}, data);
  }, [canvasRef.current, JSON.stringify(data)]);
  var computedOptions = reactExports.useMemo(function() {
  ...
  var canvas = function(ref2) {
    return React.createElement("canvas", __assign({}, !wrapper && className && { className }, { "data-testid": "canvas", height, id, onClick: function(e) {
      handleOnClick(e);
...
var CChartBar = reactExports.forwardRef(function(props, ref) {
  return React.createElement(CChart, __assign({}, props, { type: "bar", ref }));
});
CChartBar.displayName = "CChartBar";
var CChartBubble = reactExports.forwardRef(function(props, ref) {
  return React.createElement(CChart, __assign({}, props, { type: "bubble", ref }));
});
CChartBubble.displayName = "CChartBubble";
var CChartDoughnut = reactExports.forwardRef(function(props, ref) {
  return React.createElement(CChart, __assign({}, props, { type: "doughnut", ref }));
});
CChartDoughnut.displayName = "CChartDoughnut";
var CChartLine = reactExports.forwardRef(function(props, ref) {
  return React.createElement(CChart, __assign({}, props, { type: "line", ref }));
});
CChartLine.displayName = "CChartLine";
var CChartPie = reactExports.forwardRef(function(props, ref) {
  return React.createElement(CChart, __assign({}, props, { type: "pie", ref }));
});
CChartPie.displayName = "CChartPie";
var CChartPolarArea = reactExports.forwardRef(function(props, ref) {
  return React.createElement(CChart, __assign({}, props, { type: "polarArea", ref }));
});
CChartPolarArea.displayName = "CChartPolarArea";
var CChartRadar = reactExports.forwardRef(function(props, ref) {
  return React.createElement(CChart, __assign({}, props, { type: "radar", ref }));
});
CChartRadar.displayName = "CChartRadar";
var CChartScatter = reactExports.forwardRef(function(props, ref) {
  return React.createElement(CChart, __assign({}, props, { type: "scatter", ref }));
});
