...
const HeatUnitList = () => {
  ...
  const [heat_unit, setHeat_unit] = useState([]);
    ...
    < CRow>
      < CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong> Fűtőegység lista</strong> <small></small>
          </CCardHeader>
          <CCardBody>
            ...
            <CModal visible={condemnedId !== null} onClose={spareId}>
              <CModalHeader onClose={() => setVisible(false)}>
                <CModalTitle>Fűtőegység törlése</CModalTitle>
              </CModalHeader>
              <CModalBody>
                Biztosan akarod törölni ezt a fűtőegységet  #{condemnedId}?
              </CModalBody>
              <CModalFooter>
