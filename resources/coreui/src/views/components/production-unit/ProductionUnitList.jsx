    ...
    < CRow>
      < CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong> Termelőegység lista</strong> <small></small>
          </CCardHeader>
          <CCardBody>
            ...
            <CModal visible={condemnedId !== null} onClose={spareId}>
              <CModalHeader onClose={() => setVisible(false)}>
                <CModalTitle>Termelőegység törlése</CModalTitle>
              </CModalHeader>
              <CModalBody>
                Biztosan akarod törölni ezt a termelőegységet  #{condemnedId}?
              </CModalBody>
              <CModalFooter>
